...
const TechMarquee: React.FC = () => {
  const techStackRow1 = [
    ...
    // { name: "MongoDB", icon: <Layers className="w-5 h-5 mr-2" /> },
    // { name: "ExpressJS", icon: <Layers className="w-5 h-5 mr-2" /> },
    // { name: "NodeJS", icon: <Layers className="w-5 h-5 mr-2" /> },
    // { name: "PostgreSQL", icon: <Layers className="w-5 h-5 mr-2" /> },
    // { name: "Prisma", icon: <Layers className="w-5 h-5 mr-2" /> },
  ];
